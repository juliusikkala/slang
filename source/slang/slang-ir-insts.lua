...
local insts = {
	...
	{ Unrecognized = {} },
	{
		Type = {
			...
			{ DefaultLayoutWrapper = { struct_name = "DefaultLayoutWrapperType", operands = { { "valueType", "IRType" } }, hoistable = true } },
			{ Std140Wrapper = { struct_name = "Std140WrapperType", operands = { { "valueType", "IRType" } }, hoistable = true } },
			{ Std430Wrapper = { struct_name = "Std430WrapperType", operands = { { "valueType", "IRType" } }, hoistable = true } },
			{ ScalarWrapper = { struct_name = "ScalarWrapperType", operands = { { "valueType", "IRType" } }, hoistable = true } },
			{ CLayoutWrapper = { struct_name = "CLayoutWrapperType", operands = { { "valueType", "IRType" } }, hoistable = true } },
