...
local insts = {
	...
	{ Unrecognized = {} },
	{
		Type = {
			...
			{ DefaultStorageLayout = { struct_name = "DefaultStorageLayoutType", operands = { { "valueType", "IRType" } }, hoistable = true } },
			{ Std140StorageLayout = { struct_name = "Std140StorageLayoutType", operands = { { "valueType", "IRType" } }, hoistable = true } },
			{ Std430StorageLayout = { struct_name = "Std430StorageLayoutType", operands = { { "valueType", "IRType" } }, hoistable = true } },
			{ ScalarStorageLayout = { struct_name = "ScalarStorageLayoutType", operands = { { "valueType", "IRType" } }, hoistable = true } },
			{ CStorageLayout = { struct_name = "CStorageLayoutType", operands = { { "valueType", "IRType" } }, hoistable = true } },
